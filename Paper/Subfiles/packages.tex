...
\usepackage{footmisc,datetime2,refcount,hhline,rotating,makecell,subfiles}
\usepackage{subfiles}
...
% --- Fix: prevent \protected@file@percent from poisoning .aux on reread ---
\makeatletter
\providecommand\protected@file@percent{}
\gdef\protected@file@percent{}
\makeatother
