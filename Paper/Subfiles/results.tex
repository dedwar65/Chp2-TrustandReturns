...
\par I focus the main text on a subset of specifications. For income, I omit labor income and log specifications; labor income results are not statistically significant, while total income results are robust to both log and IHS. For returns, I omit core and core-plus-retirement portfolio results, which are largely insignificant across specifications. I report only net wealth (r5) returns, which show significant trust effects and are robust to raw returns and different trimming and winsorization choices.

\subsection{Income and trust}

\par After examining the determinants of trust, I test whether the hump-shaped relationship between trust and income in \cite{jbpglg2016} appears in the HRS. I use deflated winsorized total income in IHS form. Cross-section (2020) and average-over-waves results are below.
